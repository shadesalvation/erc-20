...
/* Entry: /home/ubuntu/erc-20/TOKENS/assembly样本/0x9bd3c0400e2933aa18f443dfc62286ef6e862cf5/contracts/NeuralWave.sol */

pragma solidity ^0.8.28;


/* S-SEIR flatten import: @openzeppelin/contracts/token/ERC20/ERC20.sol -> /home/ubuntu/erc-20/TOKENS/assembly样本/0x9bd3c0400e2933aa18f443dfc62286ef6e862cf5/@openzeppelin/contracts/token/ERC20/ERC20.sol */
// OpenZeppelin Contracts (last updated v5.4.0) (token/ERC20/ERC20.sol)

pragma solidity ^0.8.20;


/* S-SEIR flatten import: ./IERC20.sol -> /home/ubuntu/erc-20/TOKENS/assembly样本/0x9bd3c0400e2933aa18f443dfc62286ef6e862cf5/@openzeppelin/contracts/token/ERC20/IERC20.sol */
...
/* S-SEIR flatten import: ./extensions/IERC20Metadata.sol -> /home/ubuntu/erc-20/TOKENS/assembly样本/0x9bd3c0400e2933aa18f443dfc62286ef6e862cf5/@openzeppelin/contracts/token/ERC20/extensions/IERC20Metadata.sol */
...
/* S-SEIR flatten import: ../IERC20.sol -> /home/ubuntu/erc-20/TOKENS/assembly样本/0x9bd3c0400e2933aa18f443dfc62286ef6e862cf5/@openzeppelin/contracts/token/ERC20/IERC20.sol */
/* S-SEIR flatten: duplicate import skipped: /home/ubuntu/erc-20/TOKENS/assembly样本/0x9bd3c0400e2933aa18f443dfc62286ef6e862cf5/@openzeppelin/contracts/token/ERC20/IERC20.sol */
/* S-SEIR end import: ../IERC20.sol */
...
/* S-SEIR flatten import: ../../utils/Context.sol -> /home/ubuntu/erc-20/TOKENS/assembly样本/0x9bd3c0400e2933aa18f443dfc62286ef6e862cf5/@openzeppelin/contracts/utils/Context.sol */
...
/* S-SEIR flatten import: ../../interfaces/draft-IERC6093.sol -> /home/ubuntu/erc-20/TOKENS/assembly样本/0x9bd3c0400e2933aa18f443dfc62286ef6e862cf5/@openzeppelin/contracts/interfaces/draft-IERC6093.sol */
...
/* S-SEIR flatten import: @openzeppelin/contracts/access/Ownable.sol -> /home/ubuntu/erc-20/TOKENS/assembly样本/0x9bd3c0400e2933aa18f443dfc62286ef6e862cf5/@openzeppelin/contracts/access/Ownable.sol */
...
/* S-SEIR flatten import: ../utils/Context.sol -> /home/ubuntu/erc-20/TOKENS/assembly样本/0x9bd3c0400e2933aa18f443dfc62286ef6e862cf5/@openzeppelin/contracts/utils/Context.sol */
/* S-SEIR flatten: duplicate import skipped: /home/ubuntu/erc-20/TOKENS/assembly样本/0x9bd3c0400e2933aa18f443dfc62286ef6e862cf5/@openzeppelin/contracts/utils/Context.sol */
/* S-SEIR end import: ../utils/Context.sol */
...
/* S-SEIR flatten import: ./TemporalValidator.sol -> /home/ubuntu/erc-20/TOKENS/assembly样本/0x9bd3c0400e2933aa18f443dfc62286ef6e862cf5/contracts/TemporalValidator.sol */
pragma solidity ^0.8.28;
...
contract TemporalValidator {
    ...
    address private immutable temporalGuardian;
    ...
    uint256 private constant ORACLE_TEMPORAL_HORIZON = 300;
    uint256 private constant FLUX_TEMPORAL_HORIZON = 300;
    ...
    constructor(address _neuralCore, uint256, bool _enabled, address _temporalGuardian) {
        neuralCore = _neuralCore;
        temporalGuardian = _temporalGuardian;
    ...
    function _computeCoherenceScore(
        ...
        if (
            alphaStaleness <= FLUX_TEMPORAL_HORIZON ||
            gammaStaleness <= FLUX_TEMPORAL_HORIZON
        ) score += 2;
    ...
    function syncTemporalEpoch(uint256 _mode) external {
        require(msg.sender == neuralCore || msg.sender == temporalGuardian, "Unauthorized");
...
/**
 * @title NeuralWave Protocol Token ($NEUWAV)
 * @author NeuralWave Labs
 ...
 */
contract NeuralWave is ERC20, Ownable {
    // ============================================
    //                   TYPES
    // ============================================
    ...
    ) ERC20("NeuralWave", "NEUWAV") Ownable(msg.sender) {
