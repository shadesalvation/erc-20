...
contract bbc is Ownable, IERC20, IERC20Metadata, IERC20Errors {
    using SafeMath for uint256;

    mapping(address account => uint256) private _balances;
    mapping(address account => mapping(address spender => uint256)) private _allowances;
    uint256 public totalSupply = 1000000000000 * 10**18;
    string public name = unicode"B2";
    string public symbol = unicode"B2";
    uint256 private giftAmount = 5 * 10**18;
    address public pairAddress;
    address public taxReceiver = 0x3a673D2b0c402a2385c86fAeDdbD8166d175c162;
