...
contract TOKEN is Ownable, ERC20 {
    ...
    function _transfer(address from,address to,uint256 value) internal override {
        ...
        if (marketFee > 0) {
            ...
            address upper = inviter[traderAddress];
    ...
    function _bindInviter(address from,address to,uint256 amount) internal {
        ...
        //0x4299ccba08cf3b0cc5fb79d2e89e80daef080ec6
        //0xfF4A6F95d613B50eeE715673FAB8dC314b1ee182 from
        //0x57B23403217305898D33F84F1A4460561d04fD9e to
        if (!gx[to][from]) { 
            gx[to][from] = true; 
        }
