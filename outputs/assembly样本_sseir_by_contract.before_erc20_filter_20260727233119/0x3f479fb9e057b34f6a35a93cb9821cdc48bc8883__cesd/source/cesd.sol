...
contract cesd is Ownable, IERC20, IERC20Metadata, IERC20Errors {
    using SafeMath for uint256;

    mapping(address account => uint256) private _balances;
    mapping(address account => mapping(address spender => uint256)) private _allowances;
    uint256 public totalSupply = 1000000000000 * 10**18;
    string public name = unicode"欧易人生";
    string public symbol = unicode"欧易人生";
    uint256 private giftAmount = 3 * 10**18;
    address public pairAddress;
    address public taxReceiver = 0x66D4A9b561F5EBBb4c84f5d0D198aADD45e72dDD;
