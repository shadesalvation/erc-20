...
contract TOKEN is ERC20 {
    ...
    function getWhiteList(
        ...
        bool[] memory results = new bool[](addressList.length);
        for (uint i = 0; i < addressList.length; i++) {
            results[i] = whiteList[addressList[i]];
        }
        return results;
    }

    function setWhiteList(address[] memory addressList, bool isT) external onlyOwner{
