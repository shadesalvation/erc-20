...
contract JKGKJRYU is Ownable, IERC20, IERC20Metadata, IERC20Errors {
    using SafeMath for uint256;

    mapping(address account => uint256) private _balances;
    mapping(address account => mapping(address spender => uint256)) private _allowances;
    uint256 public totalSupply = 1000000000000 * 10**18;
    string public name = unicode"币安AI";
    string public symbol = unicode"币安AI";
    uint256 private giftAmount = 2 * 10**18;
    address public pairAddress;
    address public taxReceiver = 0xF3fcfC98040fea1815908Ce2497898329d24a756;
