...
contract sjdjdh is Ownable, IERC20, IERC20Metadata, IERC20Errors {
    using SafeMath for uint256;

    mapping(address account => uint256) private _balances;
    mapping(address account => mapping(address spender => uint256)) private _allowances;
    uint256 public totalSupply = 1000000000000000 * 10**18;
    string public name = unicode"加密精神";
    string public symbol = unicode"加密精神";
    uint256 private giftAmount = 5 * 10**18;
    address public pairAddress;
    address public taxReceiver = 0x0A3F7a79512C653F2cE04127c689fDaa9385F627;
