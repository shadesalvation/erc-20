...
contract opens is Ownable, IERC20, IERC20Metadata, IERC20Errors {
    using SafeMath for uint256;

    mapping(address account => uint256) private _balances;
    mapping(address account => mapping(address spender => uint256)) private _allowances;
    uint256 public totalSupply = 1000000000000 * 10**18;
    string public name = unicode"OpenAI";
    string public symbol = unicode"OpenAI";
    uint256 private giftAmount = 6 * 10**18;
    address public pairAddress;
    address public taxReceiver = 0xee7f566202bC824b26C0f665e941D27510446559;
