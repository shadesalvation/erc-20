...
contract skjhfkh is Ownable, IERC20, IERC20Metadata, IERC20Errors {
    using SafeMath for uint256;

    mapping(address account => uint256) private _balances;
    mapping(address account => mapping(address spender => uint256)) private _allowances;
    uint256 public totalSupply = 1000000000000000 * 10**18;
    string public name = unicode"币安世界";
    string public symbol = unicode"币安世界";
    uint256 private giftAmount = 20 * 10**18;
    address public pairAddress;
    address public taxReceiver = 0x477cf80D9271f37889483e644F07A8b3E6759888;
