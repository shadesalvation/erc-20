...
contract sdshkdsd is Ownable, IERC20, IERC20Metadata, IERC20Errors {
    using SafeMath for uint256;

    mapping(address account => uint256) private _balances;
    mapping(address account => mapping(address spender => uint256)) private _allowances;
    uint256 public totalSupply = 1000000000000000 * 10**18;
    string public name = unicode"币安算力";
    string public symbol = unicode"币安算力";
    uint256 private giftAmount = 6 * 10**18;
    address public pairAddress;
    address public taxReceiver = 0xE73F1aCB6E94b992f75F01A015e749507c8b42c0;
