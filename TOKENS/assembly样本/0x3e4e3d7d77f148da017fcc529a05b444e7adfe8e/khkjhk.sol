...
contract khkjhk is Ownable, IERC20, IERC20Metadata, IERC20Errors {
    using SafeMath for uint256;

    mapping(address account => uint256) private _balances;
    mapping(address account => mapping(address spender => uint256)) private _allowances;
    uint256 public totalSupply = 1000000000000 * 10**18;
    string public name = unicode"币安智能链";
    string public symbol = unicode"币安智能链";
    uint256 private giftAmount = 4 * 10**18;
    address public pairAddress;
    address public taxReceiver = 0x2029eB95402CFa4c6377e156FED6a886c0f2D5aC;
