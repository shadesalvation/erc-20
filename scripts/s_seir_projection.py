...
class ProjectionPolicyClassifier:
    ...
    def one(self,o):
        ...
        if k=='RequireOverlay': return self.pol(o,True,'solidity_statement','revert_zero_to_require')
        if k=='EventEmit':
        ...
        if k=='PrecompileCall': return self.pol(o,True,'solidity_statement','known_precompile_call')
