...
@dataclass
class VariableInfo:
    name: str; kind: str; type_string: str; data_location: str|None=None; src: str=""
    def to_dict(self): return asdict(self)
@dataclass
class FunctionUnit:
    function_id: str; contract: str; function: str; signature: str; ast_node: dict[str,Any]
    parameters: list[VariableInfo]=field(default_factory=list); returns: list[VariableInfo]=field(default_factory=list); locals: list[VariableInfo]=field(default_factory=list)
...
class FunctionSSEIR:
    ...
    analysis_facts: list[dict[str,Any]]=field(default_factory=list)
    def to_dict(self):
